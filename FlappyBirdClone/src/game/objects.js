...
game.createClass('Player', {
    ...
    init: function() {
        ...
        this.body.addShape(new game.Rectangle(70, 70));
    ...
    update: function() {
        ...
        this.body.angularVelocity = 0.2 * ((2 * Math.PI) - this.sprite.rotation);
        this.sprite.rotation += this.body.angularVelocity;
...
game.createClass('Obstacle', {
    ...
    init: function() {
        ...
        this.topSprite = new game.Sprite('bar1.png', game.system.width + this.width / 2, topHeight, {
            anchor: { x: 0.5, y: 0.0 },
            scale: { y: -1 }
        });
        this.topSprite.addTo(game.scene.obstacleContainer);

        this.bottomSprite = new game.Sprite('bar1.png', game.system.width + this.width / 2, topHeight + this.height, {
            anchor: { x: 0.5, y: 0.0 },
        });
