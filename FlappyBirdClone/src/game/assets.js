...
game.addAsset('diego.png');
game.addAsset('diego1.png');
game.addAsset('diego2.png');
game.addAsset('diego3.png');
game.addAsset('diego4.png');
game.addAsset('bar1.png');
game.addAsset('particle3.png');
