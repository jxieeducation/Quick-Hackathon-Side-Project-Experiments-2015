...
game.createScene('Main', {
    ...
    init: function() {
        ...
        var text = new game.PIXI.Text("Mike Is Full Of Shit!", { font: '50px Arial' });
        text.position={x: game.system.width / 2 - 100,y: game.system.height - 300};
